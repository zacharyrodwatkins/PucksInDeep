...
def plot_states(state, action, reward, next_state, done):
    ...
    ax[0, 0].imshow(state[6:9].transpose((1,2,0)))
    ax[0, 1].imshow(state[3:6].transpose((1,2,0)))
    ax[0, 2].imshow(state[0:3].transpose((1,2,0)))
    ax[1, 0].imshow(next_state[6:9].transpose((1,2,0)))
    ax[1, 1].imshow(next_state[3:6].transpose((1,2,0)))
    ax[1, 2].imshow(next_state[0:3].transpose((1,2,0)))
