...
from train_model import loss_func

model = tf.keras.models.load_model('realComplicatedModel1.model', custom_objects={'ModelLayer': ModelLayer, 'loss_func':loss_func})
